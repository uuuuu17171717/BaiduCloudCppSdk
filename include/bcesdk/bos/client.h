...
# if defined(BAIDU_BOS_CPPSDK_EXPORTS)
#  ifndef BAIDU_BOS_CPPSDK_API
#   define BAIDU_BOS_CPPSDK_API __declspec(dllexport)
#  endif
# elif !defined(BAIDU_BOS_CPPSDK_API)
#  define BAIDU_BOS_CPPSDK_API __declspec(dllimport)
# endif
...
class BAIDU_BOS_CPPSDK_API Client {
public:
