 ...
 */
#ifndef BAIDU_BOS_CPPSDK_BOS_REQUEST_DELETE_BUCKET_REQUEST_H
#define BAIDU_BOS_CPPSDK_BOS_REQUEST_DELETE_BUCKET_REQUEST_H
...
public:
    DeleteBucketRequest(const std::string &bucket_name) : BucketRequest(bucket_name) {
    }
